# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 20:06:10 2020
...
img1 = mping.imread("square.jpg")

pickle.dump(img1, open("square.p", "wb"))



'loading encrypted image'
img1 = pickle.load( open( "square.p", "rb" ),encoding='latin1')
...
plt.xlabel('')
plt.ylabel('')
plt.suptitle('Big Data Project, 2020')
plt.show()