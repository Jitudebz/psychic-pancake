# -*- coding: utf-8 -*-
"""
Created on Sun Mar  8 18:21:27 2020
...
images = gz.open("train-images-idx3-ubyte.gz", 'rb')
x = images.read()
print(x)
...
%cd "C:\Users\DEBASIS\Documents\Machine Learning\Image Processing"
img1 = np.invert(Image.open("test_img5.png").convert('L')).ravel()

img1 = Image.open("test_img5.png")

prediction2 = sess.run(tf.argmax(output_layer, 1), feed_dict={X: [img1]})
